...
class ConcentrationsControllerTest < ActionController::TestCase
  ...
  test "should create concentration" do
    assert_difference('Concentration.count') do
      post :create, concentration: { concentration_level: @concentration.concentration_level, concentration_value: @concentration.concentration_value, datetime: @concentration.datetime }
    end
  ...
  test "should update concentration" do
    patch :update, id: @concentration, concentration: { concentration_level: @concentration.concentration_level, concentration_value: @concentration.concentration_value, datetime: @concentration.datetime }
    assert_redirected_to concentration_path(assigns(:concentration))
  end
