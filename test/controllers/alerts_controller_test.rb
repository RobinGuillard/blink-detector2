...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { active: @alert.active, heures: @alert.heures, lieu: @alert.lieu, minutes: @alert.minutes }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { active: @alert.active, heures: @alert.heures, lieu: @alert.lieu, minutes: @alert.minutes }
    assert_redirected_to alert_path(assigns(:alert))
  end
